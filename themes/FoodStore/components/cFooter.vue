<template>
  <div class="cFooter">
    <div class="foodStore__contFooter">
      <div class="foodStore___FooterBG"></div>
      
      <div class="foodStore__Footer">
        <div class="foodStore__contLogo">Aqui ira el Logo</div>
        <div class="foodStore__contSN">
          <div class="foodStore__contSN-SN">
        ...
        <div class="foodStore__tel">tel: (+503)<span>7854-3245</span></div>
      </div>
    </div>
